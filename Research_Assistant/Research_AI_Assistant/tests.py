...
class TestOpenAlexService(TestCase):
    ...
    def test_search_papers_success_default(self, mock_works_class):
        ...
        mock_search_result.get.assert_called_once_with(per_page=25)
    ...
    def test_search_papers_with_filters(self, mock_works_class):
        ...
        mock_search_result.get.assert_called_once_with(per_page=10)
    ...
    def test_search_papers_api_error(self, mock_works_class):
        ...
        with self.assertRaises(OpenAlexAPIError) as cm:
            service.search_papers('error query')
...
class TestExtractionService(TestCase):
    ...
    def test_extract_metadata_full(self):
        ...
        mock_work = {
            ...
            "authorships": [
                {
                    "author": {"display_name": "John Doe", "orcid": "0000-0000-0000-0001"},
        ...
        expected = {
            ...
            "title": "Sample Research Paper",
            "authors": [
                {"name": "John Doe", "orcid": "0000-0000-0000-0001", "institutions": ["University A"]},
            ...
            "authorships": [
                {
                    ...
                    "institutions": [{"display_name": "Inst A"}, {"display_name": "Inst B"}]
                }
            ]
        }
...
class TestExtractFullTextUrl(TestCase):
    ...
    def test_extract_full_text_url_from_content_urls(self):
        ...
        mock_work = {
            "content_urls": {"pdf": "https://content.example.com/paper.pdf"}
        }
